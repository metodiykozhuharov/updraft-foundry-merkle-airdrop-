...
contract GenerateInput is Script {
    ...
    function run() public {
        types[0] = "address";
        types[1] = "uint";
        // List the addresses you want to be able to claim.
        // Anvil address -> the one used in Interact.s.sol
        whitelist[0] = "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266";
        // Anvil address -> MerkleAirDropTest.t.sol
        whitelist[1] = "0x6CA6d1e2D5347Bfab1d91e883F1915560e09129D";
        // 2 & 3 -> you can change with Sepolia address
        whitelist[2] = "0x0000000000000000000000000000000000000000";
        whitelist[3] = "0x0000000000000000000000000000000000000000";
